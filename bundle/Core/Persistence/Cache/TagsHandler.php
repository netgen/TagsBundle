...
final class TagsHandler extends AbstractInMemoryHandler implements TagsHandlerInterface
{
    ...
    public function loadChildren(int $tagId, int $offset = 0, int $limit = -1, ?array $translations = null, bool $useAlwaysAvailable = true, ?bool $showHiddenTags = null): array
    {
        ...
        return $this->tagsHandler->loadChildren($tagId, $offset, $limit, $translations, $useAlwaysAvailable, $showHiddenTags);
    }
    ...
    public function getChildrenCount(int $tagId, ?array $translations = null, bool $useAlwaysAvailable = true, ?bool $showHiddenTags = null): int
    {
        ...
        return $this->tagsHandler->getChildrenCount($tagId, $translations, $useAlwaysAvailable, $showHiddenTags);
    }
    ...
    public function loadTagsByKeyword(string $keyword, string $translation, bool $useAlwaysAvailable = true, int $offset = 0, int $limit = -1, ?bool $showHiddenTags = null): array
    {
        ...
        return $this->tagsHandler->loadTagsByKeyword($keyword, $translation, $useAlwaysAvailable, $offset, $limit, $showHiddenTags);
    }
    ...
    public function getTagsByKeywordCount(string $keyword, string $translation, bool $useAlwaysAvailable = true, ?bool $showHiddenTags = null): int
    {
        ...
        return $this->tagsHandler->getTagsByKeywordCount($keyword, $translation, $useAlwaysAvailable, $showHiddenTags);
    }
    ...
    public function searchTags(string $searchString, string $translation, bool $useAlwaysAvailable = true, int $offset = 0, int $limit = -1, ?bool $showHiddenTags = null): SearchResult
    {
        ...
        return $this->tagsHandler->searchTags($searchString, $translation, $useAlwaysAvailable, $offset, $limit, $showHiddenTags);
    }
    ...
    public function loadSynonyms(int $tagId, int $offset = 0, int $limit = -1, ?array $translations = null, bool $useAlwaysAvailable = true, ?bool $showHiddenTags = null): array
    {
        ...
        $synonyms = $this->tagsHandler->loadSynonyms($tagId, 0, -1, $translations, $useAlwaysAvailable, $showHiddenTags);
    ...
    public function getSynonymCount(int $tagId, ?array $translations = null, bool $useAlwaysAvailable = true, ?bool $showHiddenTags = null): int
    {
        ...
        return $this->tagsHandler->getSynonymCount($tagId, $translations, $useAlwaysAvailable, $showHiddenTags);
    }
    ...
    {
        $this->logger->logCall(__METHOD__, ['tag' => $tagId]);
        $this->tagsHandler->revealTag($tagId);
