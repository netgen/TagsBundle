...
final class ExceptionConversion extends Gateway
{
    ...
    {
        try {
            return $this->innerGateway->getChildren($tagId, $offset, $limit, $translations, $useAlwaysAvailable, $showHiddenTags);
        } catch (DBALException $e) {
            throw new RuntimeException('Database error', 0, $e);
        } catch (PDOException $e) {
            throw new RuntimeException('Database error', 0, $e);
    ...
    {
        try {
            return $this->innerGateway->getChildrenCount($tagId, $translations, $useAlwaysAvailable, $showHiddenTags);
        } catch (DBALException $e) {
            throw new RuntimeException('Database error', 0, $e);
        } catch (PDOException $e) {
            throw new RuntimeException('Database error', 0, $e);
    ...
    {
        try {
            return $this->innerGateway->getTagsByKeyword($keyword, $translation, $useAlwaysAvailable, $exactMatch, $offset, $limit, $showHiddenTags);
        } catch (DBALException $e) {
            throw new RuntimeException('Database error', 0, $e);
        } catch (PDOException $e) {
            throw new RuntimeException('Database error', 0, $e);
    ...
    {
        try {
            return $this->innerGateway->getTagsByKeywordCount($keyword, $translation, $useAlwaysAvailable, $showHiddenTags, $exactMatch);
        } catch (DBALException $e) {
            throw new RuntimeException('Database error', 0, $e);
        } catch (PDOException $e) {
            throw new RuntimeException('Database error', 0, $e);
    ...
    {
        try {
            return $this->innerGateway->getSynonyms($tagId, $offset, $limit, $translations, $useAlwaysAvailable, $showHiddenTags);
        } catch (DBALException $e) {
            throw new RuntimeException('Database error', 0, $e);
        } catch (PDOException $e) {
            throw new RuntimeException('Database error', 0, $e);
    ...
    {
        try {
            return $this->innerGateway->getSynonymCount($tagId, $translations, $useAlwaysAvailable, $showHiddenTags);
        } catch (DBALException $e) {
            throw new RuntimeException('Database error', 0, $e);
        } catch (PDOException $e) {
            throw new RuntimeException('Database error', 0, $e);
    ...
    {
        try {
            $this->innerGateway->revealTag($tagId);
        } catch (DBALException $e) {
            throw new RuntimeException('Database error', 0, $e);
        } catch (PDOException $e) {
            throw new RuntimeException('Database error', 0, $e);
