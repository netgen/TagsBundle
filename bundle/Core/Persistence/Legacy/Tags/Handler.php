...
class Handler implements BaseTagsHandler
{
    ...
    public function loadChildren(int $tagId, int $offset = 0, int $limit = -1, ?array $translations = null, bool $useAlwaysAvailable = true, ?bool $showHiddenTags = null): array
    {
        $tags = $this->gateway->getChildren($tagId, $offset, $limit, $translations, $useAlwaysAvailable, $showHiddenTags);
    ...
    {
        return $this->gateway->getChildrenCount($tagId, $translations, $useAlwaysAvailable, $showHiddenTags);
    }

    public function loadTagsByKeyword(string $keyword, string $translation, bool $useAlwaysAvailable = true, int $offset = 0, int $limit = -1, ?bool $showHiddenTags = null): array
    {
        $tags = $this->gateway->getTagsByKeyword($keyword, $translation, $useAlwaysAvailable, true, $offset, $limit, $showHiddenTags);

        return $this->mapper->extractTagListFromRows($tags);
    }

    public function getTagsByKeywordCount(string $keyword, string $translation, bool $useAlwaysAvailable = true, ?bool $showHiddenTags = null): int
    {
        return $this->gateway->getTagsByKeywordCount($keyword, $translation, $useAlwaysAvailable, $showHiddenTags);
    }

    public function searchTags(string $searchString, string $translation, bool $useAlwaysAvailable = true, int $offset = 0, int $limit = -1, ?bool $showHiddenTags = null): SearchResult
    {
        $tags = $this->gateway->getTagsByKeyword($searchString, $translation, $useAlwaysAvailable, false, $offset, $limit, $showHiddenTags);
        $totalCount = $this->gateway->getTagsByKeywordCount($searchString, $translation, $useAlwaysAvailable, $showHiddenTags, false);
    ...
    public function loadSynonyms(int $tagId, int $offset = 0, int $limit = -1, ?array $translations = null, bool $useAlwaysAvailable = true, ?bool $showHiddenTags = null): array
    {
        $tags = $this->gateway->getSynonyms($tagId, $offset, $limit, $translations, $useAlwaysAvailable, $showHiddenTags);
    ...
    {
        return $this->gateway->getSynonymCount($tagId, $translations, $useAlwaysAvailable, $showHiddenTags);
    }
