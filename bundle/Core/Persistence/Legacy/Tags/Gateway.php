...
abstract class Gateway
{
     ...
     */
    abstract public function getChildren(int $tagId, int $offset = 0, int $limit = -1, ?array $translations = null, bool $useAlwaysAvailable = true, ?bool $showHiddenTags = null): array;

    /**
     * Returns how many tags exist below tag identified by $tagId.
     */
    abstract public function getChildrenCount(int $tagId, ?array $translations = null, bool $useAlwaysAvailable = true, ?bool $showHiddenTags = null): int;
     ...
     */
    abstract public function getTagsByKeyword(string $keyword, string $translation, bool $useAlwaysAvailable = true, bool $exactMatch = true, int $offset = 0, int $limit = -1, ?bool $showHiddenTags = null): array;

    /**
     * Returns how many tags exist with $keyword.
     */
    abstract public function getTagsByKeywordCount(string $keyword, string $translation, bool $useAlwaysAvailable = true, ?bool $showHiddenTags = null, bool $exactMatch = true): int;
     ...
     */
    abstract public function getSynonyms(int $tagId, int $offset = 0, int $limit = -1, ?array $translations = null, bool $useAlwaysAvailable = true, ?bool $showHiddenTags = null): array;

    /**
     * Returns how many synonyms exist for a tag identified by $tagId.
     */
    abstract public function getSynonymCount(int $tagId, ?array $translations = null, bool $useAlwaysAvailable = true, ?bool $showHiddenTags = null): int;
    ...
    /**
     * Reveals tag identified by $tagId.
     */
    abstract public function revealTag(int $tagId): void;
}
