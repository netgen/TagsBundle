...
use Netgen\TagsBundle\API\Repository\Events\Tags\BeforeAddSynonymEvent as BeforeAddSynonymEventInterface;
use Netgen\TagsBundle\API\Repository\Values\Tags\SynonymCreateStruct;
use Netgen\TagsBundle\API\Repository\Values\Tags\Tag;
use Symfony\Contracts\EventDispatcher\Event;
use UnexpectedValueException;

final class BeforeAddSynonymEvent extends Event implements BeforeAddSynonymEventInterface
{
    /**
