...
class Handler implements BaseTagsHandler
{
    ...
    {
        $tags = $this->gateway->getTags( $offset, $limit );
        return $this->mapper->createTagsFromRows( $tags );
    }
    ...
    {
        return $this->gateway->getTagsCount();
    }
    ...
    {
        return $this->gateway->getRelatedContentIds( $tagId, $offset, $limit, $contentTypeId );
    }
    ...
    {
        return $this->gateway->getRelatedContentCount( $tagId, $contentTypeId );
    }
